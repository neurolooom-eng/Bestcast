...
import type { CheckSheetStatus, OkNotOk, ProductionLine, Shift, YesNo } from '../types/domain'
...
export const CHECK_SHEET_STATUS_OPTIONS: SelectOption[] = (
  ['draft', 'submitted', 'reviewed', 'approved'] satisfies CheckSheetStatus[]
